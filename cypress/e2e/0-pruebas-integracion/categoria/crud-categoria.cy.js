...
describe('CRUD Categorias', () => {
    ...
    it('AddCategoria(entidad)', () => {
        cy.wait(1000);
        cy.get('#nombreCategoria').type('insertar RIDER cypress', { delay: 100 }).should('have.value', 'insertar RIDER cypress');
        cy.wait(500);
    ...
    it('UpdateCategoria(entidad)', () => {
        ...
        cy.get('#nombreCategoria').type('update RIDER Cypress', { delay: 100 }); //Escribir "UPDATE Cypress en el textfield de nombreCategoria"
        cy.wait(500);
